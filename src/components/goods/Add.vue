        ...
        <el-tabs v-model="activeIndex" :tab-position="tabPosition"
          ...
          <el-tab-pane label="商品属性" name="2">
            <el-form-item v-for="item in onlyTableData"
                          :label="item.attr_name" :key="item.attr_id">
          ...
          <el-tab-pane label="商品图片" name="3">
            <!--
            action  图片要上传到的后台api地址,完整的api地址 http://127.0.0.1:8888/api/private/v1/
            list-type  预览图片的方式
            -->
            <el-upload
          ...
          <el-tab-pane label="商品内容" name="4">
            ...
            <!--添加商品的按钮-->
            <el-button @click="add" type="primary" style="margin: 15px 0">添加商品</el-button>
          </el-tab-pane>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            async tabClicked() {
                // 1 -->动态参数面板
                // this.addForm.goods_cat[2] 麻烦,应该用计算属性代替
            ...
            add() {
                ...
                this.$refs.addFormRef.validate(async valid => {
                    ...
                    // 2:校验成功,执行添加的业务逻辑
                    // 这样写会报错!!! this.addForm.goods_cat = this.addForm.goods_cat.join(',')
                    // 先深拷贝一次addForm对象
                    // 用lodash包的cloneDeep(obj)
